...
Groups 2 and 3 of `docs/ECTOBOX-BORROWINGS.md`, and the first part of group 4.
...
**The lints are structural, not textual.** Ectobox ships the same seven checks as
...
The first of the four groups of ideas taken from Ectobox's Script IDE
(`docs/ECTOBOX-BORROWINGS.md`, Nigel approved all four). What is portable from
